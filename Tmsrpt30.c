...
//  FIELD14=SpreadPremiumTime,VARCHAR,8,0,8,0,
//  FIELD15=TrvPlusDwellTime,VARCHAR,8,0,8,0,
//  FIELD16=TotalTime,VARCHAR,8,0,8,0,
//  FIELD17=School,VARCHAR,1,0,1,0,
//
int sort_TMSRPT30(const void *a, const void *b)
{
